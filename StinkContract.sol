...
contract STINK is BEP20, Ownable {
    ...
    address public marketingWallet = 0x0487DBc991E72872972EC62847De956b41cCD96B;
    address public devWallet = 0xADe0493389AC79BBE79DbD08e3d3c9A69E3aaA6E;
    address public opsWallet = 0x3dEafBAAD34297FfE075A0D81ebA92cC822d0f5C;
    address public stakingWallet = 0xDB025a1403441C4e7B1352d99D9270150Eb45BbE;
    ...
    Taxes public taxes = Taxes(4, 1, 2, 2, 1);
    Taxes public sellTaxes = Taxes(4, 1, 2, 2, 1);
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 stakingAmt = unitBalance * 2 * swapTaxes.staking;
            if (stakingAmt > 0) {
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _ops,  _staking, _dev);
        require((_marketing + _liquidity + _ops + _staking + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _ops,  _staking, _dev);
        require((_marketing + _liquidity + _ops + _staking + _dev) <= 20, "Must keep fees at 20% or less");
    }
